...
public class Panel extends JPanel implements Runnable{
	...
	public void newPaddles() {
		paddle1 = new Paddles(0, ((GAME_HEIGHT-PADDLE_HEIGHT)/2), PADDLE_WIDTH, PADDLE_HEIGHT,1);
		paddle2 = new Paddles((GAME_WIDTH-PADDLE_WIDTH), ((GAME_HEIGHT-PADDLE_HEIGHT)/2), PADDLE_WIDTH, PADDLE_HEIGHT,2);
	}
